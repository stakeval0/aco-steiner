...
class ACOSteiner{
  ...
  public:
    ...
    inline const vector<array<double,2>>& getConnectPoints() const {return this->points;};
    inline const array<double,2>& getConnectPoint(int index) const {return this->points[index];};
    inline void setCostFunction(const function<double(const array<double,2> &,const array<double,2> &)> &f){
      this->cost_function=f;
    };
    inline double calcCost(const array<double,2> &p1,const array<double,2> &p2) const {
    ...
    inline double getMutationProbability() const {return this->mutation_probability;};
    inline double getEvaporationCofficient() const {return this->evaporation_cofficient;};
    inline double getBasicMoveRatio() const {return this->basic_move_ratio;};
    inline double getPheromoneCofficient() const { return this->pheromone_cofficient; };
    ll getTableCapacity() const;
    inline const ACOTable& getACOTable() const {return *this->table;};
    inline const vector<QuadTreeAnt>& getQuadTreeAntV() const {return this->qtworld;};
